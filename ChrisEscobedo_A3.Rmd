...
I will sum gas and electricity costs for each individual and then calculate the median from the totals. I will include the individuals in the high-vulnerability index if their energy burden is greater than the median. 
...
leaflet() %>%
  ...
  addLegend(
    ...
    title = "Population with an<br>above average energy burden<br>for the Bay Area"
  )
```
## Discussion
