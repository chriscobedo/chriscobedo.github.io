...
```
#### Discussion
The best fit line does not seem to represent the data very well. The median residual is not centered around zero, is not very close to zero, and does not have symmetrical distribution. 
