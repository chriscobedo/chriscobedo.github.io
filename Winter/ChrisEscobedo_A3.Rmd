...
This plot demonstrates just how disproportionate electricity use is when compared to residential use, as well as gas usage for both residential and commercial use. This might imply that there is an industry that is using a large amount of electricity, specifically per the number of jobs it is producing. This implies an electricity heavy industry in the region that does not create a proportional amount of jobs for its electricty use.
