...
* The decision to use percentage of the population that is white was arbitrary, and could have used percentage of the population that is non-white, or any other race, and given different results.
...
* The center of the census tract was chosen as the focal point because the total count of stores in a census tract would not be easy to compare, as all census tracts have various shapes, areas, and populations. This assumes that the center of the census tract should give a accurate representation of the population of entire census tract, which may not be true for some areas.
...
The correlation coefficient for the model is positive and low, at .04128. which tells you that the residual errors may be high. This could be expected with such variance in census tracts and grocery store counts. Still, the model is very useful and provides statistically significant results which allow us to examine the correlation between our metrics.
