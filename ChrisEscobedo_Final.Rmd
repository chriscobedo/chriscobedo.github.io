...
*Disclaimer*: It is important to note the assumptions that were made to create these maps, and the potential issues with them. 
1. First, only the top most populated cities were chosen, perhaps leaving out valuable information from other cities. This was done to minimize the distortion that may have occurred from applying the same spatial analysis technique in an urban area and a rural area to determine access to healthy food. 
2. 
