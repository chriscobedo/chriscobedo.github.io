...
Still, there are interesting relationships that emerged that give us insight into the correlation of these factors with food access. To be clear, we cannot assign any causality to these results, since we are only studying potential correlation. We can see that, using our metrics as defined, there seems to be a large positive correlation between race and access to healthy food. That correlation becomes even stronger when controlling for income. That is to say, when a census tract has a higher percentage of 
