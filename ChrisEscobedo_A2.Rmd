...
I can't quite fuigure out how to get the cookie cutter method to work.
...
densityPal <- colorBin("RdYlGn", domain = oakland_blocks_pop_GEOIDs$density_change)
